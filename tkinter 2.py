...
first_lbl = tkinter.Label(text = "Enter first name: ", font = ("Ariel", 10, "underline"), fg="navy blue")
last_lbl = tkinter.Label(text = "Enter last name: ", font = ("Calibri", 10), fg="maroon")
